//! FCP `1Password` Connector - Main entrypoint
//!
//! A `1Password` secret management connector implementing the Flywheel Connector Protocol.
//! Provides access to vaults, items, and secret fields.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP 1Password Connector starting");
    run_fcp_loop()?;
    Ok(())
}
