//! FCP Anthropic Vertex connector entrypoint.
...
use fcp_anthropic_vertex::connector::AnthropicVertexConnector;
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Anthropic Vertex connector starting");
    run_fcp_loop()?;
    Ok(())
}
