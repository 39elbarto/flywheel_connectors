//! FCP `arXiv` Connector - Main entrypoint
//!
//! An arXiv research paper connector implementing the Flywheel Connector Protocol.
//! Provides access to paper search, metadata, PDF download, citation graphs,
//! author information, and new paper monitoring.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP arXiv Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut ArxivConnector, message: &str) -> serde_json::Value {
