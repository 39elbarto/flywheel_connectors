//! FCP Asana Connector - Main entrypoint
//!
//! An Asana project management connector implementing the Flywheel Connector Protocol.
//! Provides access to workspaces, projects, tasks, and sections.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Asana Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut AsanaConnector, message: &str) -> serde_json::Value {
