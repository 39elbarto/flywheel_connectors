//! FCP Browser Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Browser Connector starting");
    run_fcp_loop()
}
...
async fn handle_message(connector: &mut BrowserConnector, message: &str) -> serde_json::Value {
