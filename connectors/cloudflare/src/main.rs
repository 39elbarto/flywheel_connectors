//! FCP Cloudflare Connector - Main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Cloudflare Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut CloudflareConnector, message: &str) -> serde_json::Value {
