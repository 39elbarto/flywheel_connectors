//! FCP Confluence Connector - Main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Confluence Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut ConfluenceConnector, message: &str) -> serde_json::Value {
