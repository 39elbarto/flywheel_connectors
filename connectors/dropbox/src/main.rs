//! FCP Dropbox Connector - Main entrypoint
//!
//! A Dropbox file storage connector implementing the Flywheel Connector Protocol.
//! Provides access to files, folders, and account information.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Dropbox Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut DropboxConnector, message: &str) -> serde_json::Value {
