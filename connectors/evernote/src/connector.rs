...
fn operations_info() -> serde_json::Value {
    json!([
        {
            "id": "evernote.notebooks.list",
            "summary": "List all notebooks for the authenticated user",
            "capability": "evernote.notebooks.read",
            "risk_level": "low",
            "safety_tier": "safe",
            "idempotency": "strict",
        },
        {
            "id": "evernote.notes.list",
            "summary": "List notes in a notebook",
            "capability": "evernote.notes.read",
            "risk_level": "low",
            "safety_tier": "safe",
            "idempotency": "strict",
        },
        {
            "id": "evernote.notes.get",
        ...
        {
            "id": "evernote.notes.create",
            "summary": "Create a new note in a notebook",
            "capability": "evernote.notes.write",
            "risk_level": "medium",
            "safety_tier": "risky",
            "idempotency": "none",
        },
        {
            "id": "evernote.notes.delete",
