...
const BOUNDARY: &str = "This first slice starts with search and content retrieval.";
...
impl ExaConnector {
    ...
    pub async fn handle_handshake(&mut self, _params: Value) -> FcpResult<Value> {
        ...
        Ok(json!({
            ...
            "capabilities": ["exa.search", "exa.contents"]
        }))
    }
    ...
    pub async fn handle_introspect(&self) -> FcpResult<Value> {
        Ok(json!({
            ...
            "operations": [
                { "id": "exa.search", "summary": "Execute an Exa search", "capability": "exa.search", "risk_level": "low", "safety_tier": "safe", "idempotency": "strict" },
                { "id": "exa.contents", "summary": "Fetch Exa content for URLs or IDs", "capability": "exa.contents", "risk_level": "low", "safety_tier": "safe", "idempotency": "strict" }
            ],
            "events": [],
            "resource_types": []
        }))
    ...
    pub async fn handle_simulate(&self, params: Value) -> FcpResult<Value> {
        ...
        Ok(json!({
            "allowed": matches!(operation, "exa.search" | "exa.contents"),
            "reason": BOUNDARY
        }))
    }
