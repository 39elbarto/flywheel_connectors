//! FCP Feishu Connector - Main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Feishu Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut FeishuConnector, message: &str) -> serde_json::Value {
