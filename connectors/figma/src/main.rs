//! FCP Figma Connector - Main entrypoint
//!
//! A Figma design platform connector implementing the Flywheel Connector
//! Protocol. Provides access to files, components, styles, image export,
//! version history, comments, and webhooks.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Figma Connector starting");
...
async fn handle_message(connector: &mut FigmaConnector, message: &str) -> serde_json::Value {
