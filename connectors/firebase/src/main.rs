//! FCP `Firebase` connector main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Firebase Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut FirebaseConnector, message: &str) -> serde_json::Value {
