...
use fcp_firebase::client::FirebaseClient;
use fcp_firebase::connector::FirebaseConnector;
use fcp_firebase::types::{
    FirestoreBatchWriteRequest, FirestoreCreateRequest, FirestoreGetRequest, FirestoreListRequest,
    FirestoreQueryRequest, RealtimeGetRequest, RealtimeSetRequest,
};
...
fn firebase_test_auth() -> GoogleMaterializedAuth {
