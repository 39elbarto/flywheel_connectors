...
impl FirecrawlConnector {
    ...
    pub async fn handle_handshake(&mut self, _params: Value) -> FcpResult<Value> {
        ...
        Ok(json!({
            ...
            "capabilities": ["firecrawl.search", "firecrawl.scrape", "firecrawl.extract", "firecrawl.crawl"]
        }))
    }
    ...
    pub async fn handle_introspect(&self) -> FcpResult<Value> {
        Ok(json!({
            ...
            "operations": [
                { "id": "firecrawl.search", "summary": "Execute a Firecrawl search", "capability": "firecrawl.search", "risk_level": "low", "safety_tier": "safe", "idempotency": "strict" },
                { "id": "firecrawl.scrape", "summary": "Scrape one URL with Firecrawl", "capability": "firecrawl.scrape", "risk_level": "low", "safety_tier": "safe", "idempotency": "strict" },
                { "id": "firecrawl.extract", "summary": "Extract structured data with Firecrawl", "capability": "firecrawl.extract", "risk_level": "medium", "safety_tier": "safe", "idempotency": "strict" },
                { "id": "firecrawl.crawl.start", "summary": "Start a Firecrawl crawl", "capability": "firecrawl.crawl", "risk_level": "medium", "safety_tier": "safe", "idempotency": "best_effort" },
                { "id": "firecrawl.crawl.status", "summary": "Get Firecrawl crawl status", "capability": "firecrawl.crawl", "risk_level": "low", "safety_tier": "safe", "idempotency": "strict" }
            ],
            "events": [],
            "resource_types": []
        }))
