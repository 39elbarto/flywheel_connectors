//! FCP Google AI Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Google AI Connector starting");
    run_fcp_loop()
}
...
async fn handle_message(connector: &mut GoogleAiConnector, message: &str) -> serde_json::Value {
