//! FCP Google Chat Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Google Chat Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut ChatConnector, message: &str) -> serde_json::Value {
