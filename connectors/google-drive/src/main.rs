//! FCP Google Drive Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Google Drive Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut DriveConnector, message: &str) -> serde_json::Value {
