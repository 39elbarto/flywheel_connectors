//! FCP Google Forms Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Google Forms Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut FormsConnector, message: &str) -> serde_json::Value {
