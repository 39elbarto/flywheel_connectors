//! FCP Google People Connector - Main entrypoint.
//!
//! A Google People connector implementing the Flywheel Connector Protocol.
//! Provides access to contacts, directory search, and explicit contact mutation.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Google People Connector starting");
...
async fn handle_message(connector: &mut GooglePeopleConnector, message: &str) -> serde_json::Value {
