//! FCP Google Slides Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Google Slides Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut SlidesConnector, message: &str) -> serde_json::Value {
