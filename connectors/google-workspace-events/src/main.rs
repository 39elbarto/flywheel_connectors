//! FCP Google Workspace Events Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Google Workspace Events Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(
    connector: &mut WorkspaceEventsConnector,
    message: &str,
) -> serde_json::Value {
