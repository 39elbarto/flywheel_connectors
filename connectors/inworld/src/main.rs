...
async fn handle_message(connector: &mut InworldConnector, message: &str) -> serde_json::Value {
...
fn attach_id(response: &mut serde_json::Value, id: Option<serde_json::Value>) {
