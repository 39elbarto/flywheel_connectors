//! FCP Jira Connector - Main entrypoint
//!
//! An Atlassian Jira REST API connector implementing the Flywheel Connector
//! Protocol. Provides access to issues, JQL search, transitions, sprints,
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Jira Connector starting");
...
async fn handle_message(connector: &mut JiraConnector, message: &str) -> serde_json::Value {
