//! FCP LINE Connector - Main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP LINE Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut LineConnector, message: &str) -> serde_json::Value {
