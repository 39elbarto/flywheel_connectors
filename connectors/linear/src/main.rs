//! FCP Linear Connector - Main entrypoint
//!
//! A Linear GraphQL API connector implementing the Flywheel Connector Protocol.
//! Provides access to issues, projects, teams, cycles, and comments.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Linear Connector starting");
...
async fn handle_message(connector: &mut LinearConnector, message: &str) -> serde_json::Value {
