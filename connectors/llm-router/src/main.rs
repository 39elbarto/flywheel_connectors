//! FCP LLM Router Connector - Main entrypoint
//!
//! A meta-connector that routes AI/LLM requests to multiple providers
//! based on cost, latency, and capability strategies.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP LLM Router Connector starting");
...
async fn handle_message(connector: &mut LlmRouterConnector, message: &str) -> serde_json::Value {
