//! FCP Mailchimp Connector - Main entrypoint
//!
//! A Mailchimp email marketing connector implementing the Flywheel Connector Protocol.
//! Provides access to audiences, members, and campaigns.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Mailchimp Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut MailchimpConnector, message: &str) -> serde_json::Value {
