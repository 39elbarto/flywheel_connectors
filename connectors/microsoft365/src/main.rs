//! FCP Microsoft 365 Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Microsoft 365 Connector starting");
    run_fcp_loop()
}
...
async fn handle_message(connector: &mut M365Connector, message: &str) -> serde_json::Value {
