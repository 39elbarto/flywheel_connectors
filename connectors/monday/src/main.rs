//! FCP Monday.com Connector - Main entrypoint
//!
//! A Monday.com work management connector implementing the Flywheel Connector Protocol.
//! Provides access to boards, items, and updates.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Monday.com Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut MondayConnector, message: &str) -> serde_json::Value {
