//! FCP n8n Connector - Main entrypoint
//!
//! An n8n workflow automation connector implementing the Flywheel Connector Protocol.
//! Provides access to workflows and executions.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP n8n Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut N8nConnector, message: &str) -> serde_json::Value {
