//! FCP Netlify Connector - Main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Netlify Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut NetlifyConnector, message: &str) -> serde_json::Value {
