//! FCP Obsidian Connector - Main entrypoint.
...
use fcp_obsidian::ObsidianConnector;
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Obsidian Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut ObsidianConnector, message: &str) -> serde_json::Value {
