//! Microsoft Outlook connector entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Outlook Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut OutlookConnector, message: &str) -> serde_json::Value {
