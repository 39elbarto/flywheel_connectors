//! FCP Pinecone Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Pinecone Connector starting");
    run_fcp_loop()
}
...
async fn handle_message(connector: &mut PineconeConnector, message: &str) -> serde_json::Value {
