//! FCP Plaid Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Plaid Connector starting");
    run_fcp_loop()
}
...
async fn handle_message(connector: &mut PlaidConnector, message: &str) -> serde_json::Value {
