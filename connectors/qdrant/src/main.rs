//! FCP Qdrant Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Qdrant Connector starting");
    run_fcp_loop()
}
...
async fn handle_message(connector: &mut QdrantConnector, message: &str) -> serde_json::Value {
