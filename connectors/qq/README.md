...
| Gateway event projection | In scope | `qq.gateway.project_event` tracks sequence, session, matched heartbeat ack, duplicate IDs, bounded queue state, access policy, group mention gating, and lifecycle directives for host-fed gateway frames. |
