    ...
    vec![
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Using a 15-character ID instead of the 18-character case-safe ID.".into()],
                examples: vec![r#"{"account_id": "001xx000003DGbY", "fields": ["Name", "Industry"]}"#.into()],
        ...
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Not specifying fields — returns all fields which can be slow.".into()],
                examples: vec![r#"{"limit": 50, "fields": ["Id", "Name", "Industry", "AnnualRevenue"]}"#.into()],
                related: vec![
        ...
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Not specifying fields — returns all fields which can be slow and hit response size limits.".into()],
                examples: vec![r#"{"limit": 50, "fields": ["Id", "FirstName", "LastName", "Email"]}"#.into()],
                related: vec![
        ...
        op_info(
            ...
            AgentHint {
                ...
                examples: vec![r#"{"last_name": "Smith", "first_name": "Alice", "email": "alice@example.com", "account_id": "001xx000003DGbY"}"#.into()],
        ...
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Deleting contacts with active opportunities.".into()],
                examples: vec![r#"{"contact_id": "003xx000004TmiQ"}"#.into()],
                related: vec![CapabilityId::from_static("salesforce.contacts.list")],
            },
        ),
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Not filtering by status — includes converted and disqualified leads by default.".into()],
                examples: vec![r#"{"limit": 50, "fields": ["Id", "FirstName", "LastName", "Company", "Status"]}"#.into()],
                related: vec![
        ...
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Converting leads without checking for duplicate accounts.".into()],
                examples: vec![r#"{"lead_id": "00Qxx000001LaPt", "create_opportunity": true, "opportunity_name": "New Deal"}"#.into()],
                related: vec![
        ...
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Not filtering by stage — returns all stages including Closed Lost, which inflates results.".into()],
                examples: vec![r#"{"limit": 50, "fields": ["Id", "Name", "StageName", "Amount", "CloseDate"]}"#.into()],
                related: vec![
        ...
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Not specifying account_id — opportunity won't be linked to an account.".into()],
                examples: vec![r#"{"name": "Enterprise Deal", "stage_name": "Prospecting", "close_date": "2026-06-30", "amount": 50000}"#.into()],
                related: vec![
        ...
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Not filtering by status — returns all cases including closed, which can be a very large result set.".into()],
                examples: vec![r#"{"limit": 50, "status": "Open", "fields": ["Id", "Subject", "Status", "Priority"]}"#.into()],
        ...
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Not linking the case to an account_id or contact_id — unlinked cases are hard to track.".into()],
                examples: vec![r#"{"subject": "Login issue", "priority": "High", "account_id": "001xx000003DGbY"}"#.into()],
        ...
        op_info(
            ...
            AgentHint {
                ...
                examples: vec![r#"{"query": "SELECT Id, Name, Amount FROM Opportunity WHERE StageName = 'Closed Won' LIMIT 100"}"#.into()],
                related: vec![
                    CapabilityId::from_static("salesforce.accounts.list"),
                    CapabilityId::from_static("salesforce.contacts.list"),
        ...
        op_info(
            ...
            AgentHint {
                ...
                common_mistakes: vec!["Not checking report format — tabular/summary/matrix return different structures.".into()],
                examples: vec![r#"{"report_id": "00Oxx0000004cGr", "include_details": true}"#.into()],
...
mod tests {
    ...
    fn operations_info_has_13_operations() {
        assert_eq!(ops_json().as_array().unwrap().len(), 13);
    }
