//! FCP `Semantic Scholar` Connector - Main entrypoint
//!
//! A Semantic Scholar academic paper connector implementing the Flywheel Connector Protocol.
//! Provides access to paper search, details, citations, references, recommendations,
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Semantic Scholar Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(
    connector: &mut SemanticScholarConnector,
    message: &str,
) -> serde_json::Value {
