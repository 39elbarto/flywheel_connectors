//! FCP Shopify Connector - Main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Shopify Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut ShopifyConnector, message: &str) -> serde_json::Value {
