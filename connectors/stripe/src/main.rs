//! FCP Stripe Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Stripe Connector starting");
    run_fcp_loop()
}
...
async fn handle_message(connector: &mut StripeConnector, message: &str) -> serde_json::Value {
