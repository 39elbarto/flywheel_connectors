//! FCP Supabase Connector - Main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Supabase Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut SupabaseConnector, message: &str) -> serde_json::Value {
