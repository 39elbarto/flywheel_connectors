//! FCP Teams Connector - Main entrypoint.
...
use fcp_teams::connector::TeamsConnector;
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Teams Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut TeamsConnector, message: &str) -> serde_json::Value {
