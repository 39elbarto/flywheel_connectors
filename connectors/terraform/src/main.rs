//! FCP Terraform Cloud Connector - Main entrypoint
//!
//! A Terraform Cloud/Enterprise connector implementing the Flywheel Connector Protocol.
//! Provides access to workspaces, runs, and applies.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Terraform Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut TerraformConnector, message: &str) -> serde_json::Value {
