//! FCP Trello Connector - Main entrypoint
//!
//! A Trello kanban board connector implementing the Flywheel Connector Protocol.
//! Provides access to boards, lists, cards, labels, and members.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Trello Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut TrelloConnector, message: &str) -> serde_json::Value {
