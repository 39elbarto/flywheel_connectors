//! FCP Twilio Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Twilio Connector starting");
    run_fcp_loop()
}
...
async fn handle_message(connector: &mut TwilioConnector, message: &str) -> serde_json::Value {
