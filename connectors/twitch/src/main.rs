//! FCP Twitch Connector - Main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Twitch Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut TwitchConnector, message: &str) -> serde_json::Value {
