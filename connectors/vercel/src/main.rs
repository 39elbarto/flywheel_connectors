//! FCP Vercel Connector - Main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Vercel Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut VercelConnector, message: &str) -> serde_json::Value {
