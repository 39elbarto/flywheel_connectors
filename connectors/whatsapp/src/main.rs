//! FCP WhatsApp Connector - Main entrypoint.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP WhatsApp Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut WhatsAppConnector, message: &str) -> serde_json::Value {
