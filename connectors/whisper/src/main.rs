//! FCP Whisper Connector - Main entrypoint
//!
//! A Whisper audio transcription connector implementing the Flywheel Connector Protocol.
//! Provides access to audio transcription, translation, and language detection via HTTP.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Whisper Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut WhisperConnector, message: &str) -> serde_json::Value {
