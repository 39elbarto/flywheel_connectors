    ...
    pub async fn handle_introspect(&self) -> FcpResult<Value> {
        Ok(json!({
            ...
            "operations": [
                ...
                { "id": WEBHOOK_INGEST_OPERATION_ID, "summary": "Validate and normalize a host-forwarded Zalo webhook request", "capability": "zalo.events", "risk_level": "low", "safety_tier": "safe", "idempotency": "strict", "implemented": true },
