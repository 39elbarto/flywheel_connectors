//! FCP Zapier Connector - Main entrypoint
//!
//! A Zapier automation connector implementing the Flywheel Connector Protocol.
//! Provides access to zaps listing and execution via the Zapier NLA API.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Zapier Connector starting");
    run_fcp_loop()?;
    Ok(())
}
...
async fn handle_message(connector: &mut ZapierConnector, message: &str) -> serde_json::Value {
