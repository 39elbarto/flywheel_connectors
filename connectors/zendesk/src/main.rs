//! FCP Zendesk Connector - Main entrypoint
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Zendesk Connector starting");
    run_fcp_loop()
}
...
async fn handle_message(connector: &mut ZendeskConnector, message: &str) -> serde_json::Value {
