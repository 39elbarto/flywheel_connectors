...
impl CapabilityTokenGoldenVector {
    ...
    pub fn vector_1_basic_capability() -> Self {
        Self {
            ...
            expected_public_key: "8a88e3dd7409f195fd52db2d3cba5d72ca6709bf1d94121bf3748801b40f6f5c"
                .into(),
            expected_kid: "".into(), // Will be computed at verification time
            ...
            expected_claims_cbor: "".into(), // Filled by generate()
            expected_token_cbor: "".into(),  // Filled by generate()
        }
    }
    ...
    pub fn vector_2_with_holder_and_checkpoint() -> Self {
        Self {
            ...
            expected_claims_cbor: "".into(),
            expected_token_cbor: "".into(),
        }
    }
