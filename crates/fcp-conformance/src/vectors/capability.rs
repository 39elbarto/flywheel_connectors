...
impl CapabilityTokenGoldenVector {
    ...
    pub fn vector_1_basic_capability() -> Self {
        Self {
            ...
            // Regenerated after 6df66c79 switched the encoder from
            // numeric-i64 ordering to RFC 8949 bytewise lex (br-b6rtk).
            // The `expected_claims_cbor` reflects raw CwtClaims::to_cbor
            // (8 entries) BEFORE `CoseToken::sign` synthesizes the
            // current SCHEMA_VERSION; `expected_token_cbor` reflects the
            // signed payload AFTER synthesis (9 entries).
            ...
            expected_token_cbor: "".into(),
        }
    }
    ...
    pub fn vector_2_with_holder_and_checkpoint() -> Self {
        Self {
            ...
            expected_token_cbor: "".into(),
        }
    }
    ...
    pub fn vector_3_multi_operation() -> Self {
        Self {
            ...
            expected_token_cbor: "".into(),
        }
    }
