...
impl CapabilityTokenGoldenVector {
    ...
    pub fn vector_1_basic_capability() -> Self {
        Self {
            ...
            // RFC 8949 canonical CBOR map-key order: positives first
            // (by value), then negatives by ascending N = -1-key.
            // Regenerated twice:
            //   * 6df66c79 — encoder switched to RFC 8949 bytewise lex (br-b6rtk).
            //   * c828a3e7 — principal_zone synthesized at CWT key 3 by
            //     `CoseToken::sign` ("add principal zone access floor");
            //     expected_token_cbor regen closes br-lobrq.
            // `expected_claims_cbor` reflects raw CwtClaims::to_cbor (8
            // entries) BEFORE sign synthesizes SCHEMA_VERSION (key -16)
            // and principal_zone (key 3). `expected_token_cbor` reflects
            // the signed payload AFTER synthesis (10 entries = 8 + 2).
            expected_claims_cbor: "".into(),
            expected_token_cbor: "".into(),
        }
    }
    ...
    pub fn vector_2_with_holder_and_checkpoint() -> Self {
        Self {
            ...
            // expected_token_cbor regenerated after c828a3e7 (principal_zone at
            // CWT key 3 synthesized by CoseToken::sign). Raw claims CBOR
            // unchanged — principal_zone is sign-time synthesis, not a
            // CwtClaims field. (br-lobrq)
            expected_claims_cbor: "".into(),
            expected_token_cbor: "".into(),
        }
    }
    ...
    pub fn vector_3_multi_operation() -> Self {
        Self {
            ...
            // expected_token_cbor regenerated after c828a3e7 (sign-time
            // principal_zone synthesis). Raw claims unchanged. (br-lobrq)
            expected_claims_cbor: "".into(),
            expected_token_cbor: "".into(),
        }
    }
...
mod tests {
    ...
    /// ONE-SHOT REGEN HELPER — run with `-- --ignored --nocapture` to dump
    /// the current canonical claims + token CBOR for each golden vector.
    /// Use the output to refresh `expected_claims_cbor` / `expected_token_cbor`
    ...
    fn regen_dump_golden_bytes() {
        ...
        for v in CapabilityTokenGoldenVector::load_all() {
            let sk_bytes: [u8; 32] = hex::decode(&v.signing_key).unwrap().try_into().unwrap();
            let sk = Ed25519SigningKey::from_bytes(&sk_bytes).unwrap();

            let nbf = DateTime::from_timestamp(v.not_before, 0).unwrap();
            let exp = DateTime::from_timestamp(v.expires, 0).unwrap();
            let mut claims = CwtClaims::new()
                .issuer(&v.issuer)
                .capability_id(&v.capability_id)
                .zone_id(&v.zone_id)
                .principal_id(&v.principal_id)
                .issuing_node(&v.issuing_node)
                .not_before(nbf)
                .expiration(exp);
            let ops: Vec<&str> = v.operations.iter().map(String::as_str).collect();
            claims = claims.operations(&ops);
            if let Some(ref h) = v.holder_node {
                claims = claims.holder_node(h);
            }
            if let (Some(chk_id_hex), Some(chk_seq)) = (&v.checkpoint_id, v.checkpoint_seq) {
                let chk = hex::decode(chk_id_hex).unwrap();
                claims = claims.checkpoint(&chk, chk_seq);
            }
            ...
            eprintln!("---- {} ----", v.description);
            eprintln!("claims: {}", hex::encode(&claims_cbor));
            eprintln!("token:  {}", hex::encode(&token_cbor));
        }
    }
}
