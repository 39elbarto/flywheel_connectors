...
Summary: `0/19` Batch 4 connectors currently pass the graduation gauntlet.

Pre-promotion status: `19/19` Batch 4 connectors pass every check before `readme_status_match`; none should be called PROVEN until the full proof bundle lands.
