...
Summary: `0/21` Batch 4 connectors currently pass the graduation gauntlet.

Pre-promotion status: `21/21` Batch 4 connectors pass every check before `readme_status_match`; none should be called PROVEN until the full proof bundle lands.
